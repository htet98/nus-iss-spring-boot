...
public class CategoryRepository__BeanDefinitions {
  ...
  public static BeanDefinition getCategoryRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "sg.edu.nus.jpademo.repo.CategoryRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new sg.edu.nus.jpademo.repo.CategoryRepositoryImpl__AotRepository(entityManager, context));
      }
    });
